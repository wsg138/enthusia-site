...
test("public preview uses the self-hosted Minecraft font and contains mobile podium scores", async () => {
  ...
  assert.match(siteStyles, /html body :where\(h1,h2,h3,h4,h5,h6,button/);
  assert.match(siteStyles, /font-family:Inter,system-ui,"Segoe UI",Roboto,Helvetica,Arial,sans-serif!important/);
