...
UA = 'EnthusiaWikiMinervaMobile/1.0 (owner-authorized wiki publisher)'
...
def main():
    ...
    css = edit_exact(
        ...
        'Fix Enthusia Minerva mobile header branding and menu', 'css'
    )
    ...
    js = edit_exact(
        ...
        'Route mobile hamburger to Enthusia menu and restore header brand', 'javascript'
    )
